                  ...
                  <div className="mb-6">
                    ...
                    <div className="flex flex-wrap items-center gap-4 text-gray-600 mb-4">
                      ...
                      <div className="flex items-center">
                        ...
                        <span>{job?.job_detail?.employmentType ? getEmploymentTypeLabel(job.job_detail.employmentType) : 'Chưa xác định'}</span>
                      </div>
                    </div>
              ...
              <Card className="border-0 shadow-xl bg-white">
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <Badge variant="outline">{job?.job_detail?.employmentType ? getEmploymentTypeLabel(job.job_detail.employmentType) : 'Chưa xác định'}</Badge>
                  </div>
