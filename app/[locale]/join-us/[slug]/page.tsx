...
import { StrapiJobItem, getEmploymentTypeLabel, convertJobDescriptionToHtml } from "@/types/job-real"
...
export default function JobDetailPage() {
  ...
  const getJobType = () => job?.job_detail?.employmentType ? getEmploymentTypeLabel(job.job_detail.employmentType) : 'Chưa xác định'
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="space-y-6">
                ...
                <Card>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center">
                      <Calendar className="h-5 w-5 text-purple-500 mr-3" />
                      <div>
                        <div className="font-medium">Valid Through</div>
              ...
              <motion.div variants={itemVariants}>
                <Card>
                  <CardHeader>
                    <CardTitle>Working Information</CardTitle>
                  </CardHeader>
                  <CardContent className="space-y-4">
